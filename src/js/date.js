...
console.log("date04.toLocaleString():::", date04.toLocaleString());
// 3/16/2030, 2:25:00 PM
// 20.04.2024, 11:44:29
console.log("date04.getTime():::", date04.getTime());
// 1713602694270

// ^ Date.now() и new Date().getTime()
const date05 = new Date();
// Спочатку створюється об'єкт, а потім на ньому викликається getTime() - повільно, бо працює очищувач пам'яті
console.log("date05.getTime():::", date05.getTime()); // 1713697756182

Date.now(); //
console.log("Date.now():::", Date.now()); // 1713697756182 - одразу доступ до дати, без створення і подальшого видалення об'єкта
